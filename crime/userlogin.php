...
<body style="background-size: cover;
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h1 style="color: #CCEEFF;">User Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color: #CCEEFF; ">Password</h1></label>
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>kaustubhbhakare</b></h4>
</div>
